...
>
  <head>
    ...
    <link rel="stylesheet" href="{{asset('dashboard/assets/vendor/libs/apex-charts/apex-charts.cs')}}s" />
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="{{route('admindashboard')}}" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">EBuy</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="{{route('rejectedorders')}}" class="menu-link">
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            ...
                            <small class="text-muted">admin@admin.com</small>
                          </div>
                        </div>
                      </a>
                    </li>
                    ...
                    {{-- <li>
                      <a class="dropdown-item" href="">
                        <span class="d-flex align-items-center align-middle">
                          ...
                          <span class="flex-grow-1 align-middle">Pending Orders </span>
