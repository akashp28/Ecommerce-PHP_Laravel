...
<html lang="en">
   ...
   <body>
               ...
               <div class="row">
                  <div class="col-sm-12">
                     <div class="logo">
                        ...
                        <a href="{{route('home')}}"> <h1 style="color: aliceblue; font-size:4rem; font-family: cursive; font-weight: bolder; ">E Buy</h1></a>
                     </div>
                  </div>
               </div>
            </div>
         ...
         <div class="header_section">
            <div class="container">
               <div class="containt_main">
                  ...
                  <div class="dropdown">
                     <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Product Category 
                     </button>
      ...
      <div class="footer_section layout_padding">
         <div class="container">
            <div class="footer_logo"> <a href="{{route('home')}}"> <h1 style="color: aliceblue; font-size:4rem; font-family: cursive; font-weight: bolder; ">E Buy</h1></a></div>
            <div class="input_bt">
